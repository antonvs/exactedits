...
<bind tag="fn"><sup><a name="footref-$(content)" href="#foot-$(content)" class="fn">[<content/>]</a></sup></bind> 
<html>
  ...
  <body>
      <div id="header">
        ...
        <div id="slogan">
          <img src="media/img/slogan3.png" alt="for editing and proof-reading" width="360" height="20">
        </div>
      </div>
      <div id="sidebar">
        <apply template="nav"/>
