...
<p>
Initially I need to view a document to establish the amount of work required, discuss your purpose and aims, and the extent of my involvement before estimating costs.
</p>
<p>
I work with:
</p>
<ul>
<li>MS Word 2010 (compatible with earlier versions), using Track Changes
</li>
<li>Editing-enabled PDF documents
</li>
<li>British Standard proof-reading symbols on hard copy documents
</li></ul>
<p> 
...
<li>Accurate or correct in all details
</li>
<li>Tending to be accurate and careful about minor details 
</li></ul>
<p>
Hence the operating name Exact Edits, which sums up my approach to copy-editing and proof-reading. 
</p>
</apply>
